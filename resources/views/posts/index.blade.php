...
<main class="grid grid-cols-1 lg:grid-cols-2 gap-6 my-12 mx-11 w-2xl container px-2 mx-auto">
  ...
  <style>
    ...
    <article class="">
        ...
        <form action="{{ route('posts') }}" method="post" class="bg-white shadow rounded-lg mb-6 p-4">
          @csrf
              <h1 class="font-bold text-xl text-center">SELL YOUR BOOKS & MATERIALS</h1>
